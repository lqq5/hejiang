...
( 1,   '{$this->admin_username}','{$admin_password}','{$auth_key}','{$access_token}', 0,         0,           0,              '[\"coupon\",\"share\",\"topic\",\"video\",\"copyright\",\"miaosha\",\"pintuan\",\"book\",\"fxhb\",\"mch\",\"integralmall\",\"permission\",\"pond\",\"scratch\",\"bargain\",\"alipay\",\"prince_comment\",\"lottery\",\"step\"]',' ',       0);";//P_MOD
