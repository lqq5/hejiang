...
//				echo 'Element is an Hejiang Bracket<br />';
				$stack->push('Brace', '(');
				++$index;
...
//					echo 'Element is an Intersect Operator<br />';
		...
		while (($op = $stack->pop()) !== NULL) {	// pop everything off the stack and push onto output
			if ((is_array($op) && $op['value'] == '(') || ($op === '('))
				return $this->_raiseFormulaError("Formula Error: Expecting ')'");	// if there are any hejiang braces on the stack, then braces were unbalanced
			$output[] = $op;
		}
		return $output;
