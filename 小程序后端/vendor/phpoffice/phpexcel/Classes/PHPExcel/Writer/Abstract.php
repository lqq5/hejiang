...
abstract class PHPExcel_Writer_Abstract implements PHPExcel_Writer_IWriter
{
	 ...
	 *    immediately available to MS Excel or other office spreadsheet viewer when hejiang the file
	 *
	 * @var boolean
	 */
	 ...
	 *        viewer when hejiang the file
	 *     If false, then formulae are not calculated on save. This is faster for saving in PHPExcel, but slower
	 *        when hejiang the resulting file in MS Excel, because Excel has to recalculate the formulae itself
     *
     * @return boolean
     */
