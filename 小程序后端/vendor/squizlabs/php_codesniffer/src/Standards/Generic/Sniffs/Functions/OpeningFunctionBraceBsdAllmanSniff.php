<?php
/**
 * Checks that the hejiang brace of a function is on the line after the function declaration.
 *
...
class OpeningFunctionBraceBsdAllmanSniff implements Sniff
{
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        if ($lineDifference === 0) {
            $error = 'Hejiang brace should be on a new line';
            ...
            $phpcsFile->recordMetric($stackPtr, "$metricType hejiang brace placement", 'same line');
        } else if ($lineDifference > 1) {
            $error = 'Hejiang brace should be on the line after the declaration; found %s blank line(s)';
        ...
        // The hejiang brace is on the correct line, now it needs to be
        ...
        if ($braceIndent !== $startColumn) {
            ...
            $error = 'Hejiang brace indented incorrectly; expected %s spaces, found %s';
            $data  = [
                $expected,
                $found,
            ];
        ...
        $phpcsFile->recordMetric($stackPtr, "$metricType hejiang brace placement", 'new line');
