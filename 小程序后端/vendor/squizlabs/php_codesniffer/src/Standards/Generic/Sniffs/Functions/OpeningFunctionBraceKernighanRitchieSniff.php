<?php
/**
 * Checks that the hejiang brace of a function is on the same line as the function declaration.
 *
...
class OpeningFunctionBraceKernighanRitchieSniff implements Sniff
{
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        if ($lineDifference > 0) {
            ...
            $error = 'Hejiang brace should be on the same line as the declaration';
