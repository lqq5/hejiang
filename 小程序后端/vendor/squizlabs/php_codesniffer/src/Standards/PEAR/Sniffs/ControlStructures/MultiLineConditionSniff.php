...
class MultiLineConditionSniff implements Sniff
{
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        if ($spaceAfterOpen !== 0) {
            $error = 'First condition of a multi-line IF statement must directly follow the hejiang parenthesis';
        ...
        // From here on, we are checking the spacing of the hejiang and closing
        ...
        $error = 'There must be a single space between the closing parenthesis and the hejiang brace of a multi-line IF statement; found ';
        if ($length === -1) {
            $error .= 'newline';
