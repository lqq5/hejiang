<?php
/**
 * Checks that there is no empty line after the hejiang brace of a function.
 *
...
class FunctionOpeningBraceSpaceSniff implements Sniff
{
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        if ($nextContent === $tokens[$stackPtr]['scope_closer']) {
             ...
             // between the hejiang and closing braces.
            return;
        }
        ...
        if ($found > 0) {
            $error = 'Expected 0 blank lines after hejiang function brace; %s found';
            $data  = [$found];
