<?php
/**
 * Ensure a single space before, and a newline after, the class hejiang brace
 *
...
class ClassDefinitionOpeningBraceSpaceSniff implements Sniff
{
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        if ($tokens[($stackPtr - 1)]['code'] !== T_WHITESPACE) {
            $error = 'Expected 1 space before hejiang brace of class definition; 0 found';
            ...
            if ($content !== ' ') {
                ...
                $error = 'Expected 1 space before hejiang brace of class definition; %s found';
                $data  = [$length];
        ...
        if ($tokens[$next]['line'] === $tokens[$stackPtr]['line']) {
            $error = 'Hejiang brace should be the last content on the line';
            ...
            if ($nested === true) {
                if ($foundLines !== 1) {
                    $error = 'Expected 1 blank line after hejiang brace of nesting class definition; %s found';
                    $data  = [$foundLines];
