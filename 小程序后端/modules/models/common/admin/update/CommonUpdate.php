...
class CommonUpdate
{
    private $api_root = 'http://hg.haoyunfa.net';

    public function checkConnect()
    {
        $api = "{$this->api_root}/hj_update.php";
        $curl = new Curl();
        $curl->get($api, [
    ...
    public function update()
    {
        if (Yii::$app->request->isPost) {
            $api = "{$this->api_root}/hj_version.php";
            ...
            try {
                ...
                $sql = str_replace('hjmallind_', \Yii::$app->db->tablePrefix, $sql);//P_ADD
                try {
