...
class StoreSettingForm extends MchModel
{
    ...
    public function rules()
    {
        return [
            ...
            [['show_customer_service', 'cat_style', 'cut_thread', 'purchase_frame', 'is_recommend', 'cat_goods_cols', 'is_offline', 'is_coupon', 'cat_goods_count', 'send_type', 'nav_count', 'dial', 'is_comment', 'is_sales', 'phone_auth', 'buy_member', 'mobile_verify'], 'integer', 'max'=>99999999],
