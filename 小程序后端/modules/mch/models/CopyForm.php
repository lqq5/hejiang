...
//            $id = $this->preg_substr('/&?id=/', '/&/', $arr[1]);
    ...
    {
        $api = "http://112.74.125.57/hj_tb_copy.php";
    ...
    {
        $api = "http://112.74.125.57/hj_1688_copy.php";
    ...
    {
        $api = "http://112.74.125.57/hj_jd_copy.php";
        $curl = Cloud::apiGet($api, ['vid'=>$id,'host'=> \Yii::$app->request->hostName]);
        $res = json_decode($curl->response, true);
        if ($res && isset($res['code'])) {
            if ($res['code'] != 0) {
...
//            }
//        }
        $api = "http://112.74.125.57/hj_tb_copy.php";//P_MOD
