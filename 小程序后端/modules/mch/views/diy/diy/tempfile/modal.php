...
<div class="modal fade bd-example-modal-lg" id="adModal" aria-labelledby="myLargeModalLabel" data-backdrop="static" style="z-index: 1040;">
    <div class="modal-dialog modal-lg" role="document">
        <div class="panel">
            <div class="panel-header">
                <span>弹窗广告设置</span>
            ...
            <div class="panel-body" style="max-height: 700px;overflow-y: auto;padding: 24px 0 24px 48px;">
                <div class="d-flex" v-for="(item,index) in temp_list" v-if="index == temp_index && item.type == 'modal'">
                    <div class="ad-modal-block d-flex align-items-center justify-content-center">
                        <div class="ad-modal-img" :style="{'backgroundColor':(item.param.list[0].pic_url ? '':'#fff')}">
                            <div :style="{'backgroundImage':'url('+item.param.list[0].pic_url+')'}">
                            </div>
                        </div>
                    </div>
                    <div class="col">
