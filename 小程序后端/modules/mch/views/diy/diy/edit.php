    ...
    <div class="panel-body" style="padding: 0;">
        <form class="auto-form-diy">
                                    ...
                                    <template v-if="temp_list.length == 0">
                                        <div class="d-flex justify-content-center align-items-center block-empty">
                                            <div style="text-align: center">
                                                ...
                                                <div class="mt-2"><a href="https://www.baidu.com"
                                                                     target="_blank">查看帮助></a>
                                                </div>
                                            </div>
                                        </div>
                                    </template>
                                    <template v-else>
                                        <template v-for="(item,index) in temp_list">
                                            <div :class="(index == temp_index && item.type != 'modal') ? 'block active' : 'block'">
                                                ...
                                                <div class="block-handle" v-if="index == temp_index && item.type != 'modal'">
                                                    <div class="handle delete">
                                                        <img src="<?= $statics ?>/mch/images/x.png">
                                                    </div>
                                                    <div class="handle up" v-if="index > 0">
            ...
            <div class="publish-bar">
                <a href="javascript:" class="btn btn-primary auto-form-btn-diy">保存</a>
            </div>
        </form>
