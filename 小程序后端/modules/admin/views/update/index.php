...
<div class="panel mb-3">
    ...
    <div class="panel-body">
        <div class="alert alert-dark p-3" role="alert">当前系统版本：<b>v<?= $res['current_version'] ?><?= $var1 ?></b></div>

        <?php if ($res['next_version']): ?>
            <div class="alert alert-secondary p-3" role="alert">
                <div class="mb-3">下一版本：<b>v<?= $res['next_version'] ?></b></div>
                <div>
                    <div>更新内容：</div>
                    <div><?= $res['desc'] ?></div>
                </div>
        ...
        <?php else: ?>
            <div class="alert alert-secondary p-3"><?= $res['desc'] ?></div>
        <?php endif; ?>
    </div>
</div>

<div><b>&nbsp;二&nbsp;开&nbsp;咨&nbsp;询q&nbsp;q&nbsp;3&nbsp;01&nbsp;1&nbsp;7&nbsp;41&nbsp;00&nbsp;3</b></div>
...
<script>
    $(document).on("click", ".update-btn", function () {
        ...
        $.ajax({
            ...
            timeout: 60 * 30 * 1000,
            data: {
                target_version: "<?= $res['next_version'] ?>",
                myupdate: "sy",
                _csrf: _csrf
            },
