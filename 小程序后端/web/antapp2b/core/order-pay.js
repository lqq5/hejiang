...
var pay = {
    init: function(page, _app) {
        ...
        _this.page.orderPay = function(e) {
            ...
            paramData.parent_id = getApp().core.getStorageSync(getApp().const.PARENT_ID); // TODO 从缓存中获取
                            ...
                            if (data.payment == 0) {
                                app.request({
                                    ...
                                    data: {
                                        ...
                                        pay_type: 'WECHAT_PAY',
                                        parent_user_id: getApp().core.getStorageSync(getApp().const.PARENT_ID), // TODO 从缓存中获取
                                        condition: 2, //首次付款
                                    },
                                    success: function(res) {
                                        if (res.code == 0) {
